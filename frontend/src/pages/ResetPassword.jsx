  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const result = await axios.post(
        `${backendbaseurl}/api/auth/resetpassword/${id}/${token}`,
        formData
      );

      toast.success(result.data?.msg || 'Password updated successfully!');
      ...
      <div className="relative hidden lg:flex flex-col justify-between p-12 overflow-hidden bg-gradient-to-br from-indigo-900 via-slate-900 to-black border-r border-slate-800">
        ...
        <div className="relative z-10 max-w-lg space-y-6">
          ...
          <p className="text-slate-400 text-lg leading-relaxed">
            Choose a strong password with letters, numbers, and symbols to ensure maximum security for your chats.
          </p>
        </div>
